...
Java_com_mokhtarabadi_pegasocks_MainNative_start_1tun2socks(JNIEnv *env, jclass clazz,
                                                            jobjectArray args) {
    //argc
...
Java_com_mokhtarabadi_pegasocks_MainNative_stopTun2Socks(JNIEnv *env, jclass clazz) {
    tun2socks_terminate();
}

extern "C"
JNIEXPORT void JNICALL
Java_com_mokhtarabadi_pegasocks_MainNative_printTun2SocksHelp(JNIEnv *env, jclass clazz) {
    tun2socks_print_help("badvpn-tun2socks");
}

extern "C"
JNIEXPORT void JNICALL
Java_com_mokhtarabadi_pegasocks_MainNative_printTun2SocksVersion(JNIEnv *env, jclass clazz) {
    tun2socks_print_version();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mokhtarabadi_pegasocks_MainNative_startPegaSocks(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_mokhtarabadi_pegasocks_MainNative_stopPegaSocks(JNIEnv *env, jclass clazz) {
    pgs_stop();
}
