...
public class MainService extends VpnService {
    ...
    private void startService() {
        ...
        if (supportIPv6) {
            ...
            for (String iPv6DNSServer : new HashSet<>(Arrays.asList("2606:4700:4700::1001", "2606:4700:4700::1111"))) {
        ...
        new Thread(() -> {
            ...
            boolean result = MainNative.startPegas(configFile.getAbsolutePath(), 1);
        ...
        tun2SocksThread = new Thread(() -> {
            ...
            boolean result = MainNative.startTun2Socks(
                    descriptor,
                    PRIVATE_MTU,
                    "127.0.0.1",
                    1080,
